    ...
    <main className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-zinc-500 text-sm mt-0.5">Resumen de hoy</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-zinc-200 p-6 mb-4">
        <div className="flex items-end justify-between mb-4">
          <div>
            ...
            <div className="text-zinc-500 text-sm mt-1">kcal consumidas</div>
          </div>
          <div className="text-right">
            ...
            <div className="text-zinc-500 text-sm">{remaining < 0 ? 'excedido' : 'restantes'}</div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        {[
          ...
          <div key={label} className="bg-white rounded-xl border border-zinc-200 p-4">
            ...
            <div className="text-xs text-zinc-500 mb-2.5">de {goal}g</div>
              ...
              <div key={key} className="px-5 py-3.5">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span className="text-sm tabular-nums text-zinc-800">
                    ...
                    <span className="text-zinc-500"> / {Math.round(mealGoal)} kcal</span>
                  </span>
                </div>
      ...
      {entries.length === 0 && (
        <div className="text-center py-10 bg-white rounded-xl border border-zinc-200">
          <p className="text-zinc-500">Sin registros hoy</p>
